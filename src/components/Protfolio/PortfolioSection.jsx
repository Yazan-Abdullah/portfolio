...
const PortfolioSection = ({ data }) => {
  ...
  const getData = (imgLink, title, subTitle,description,technologies) => {
    let tempData = [imgLink, title, subTitle,description,technologies];
  ...
  return (
    <>
      ...
      {modal === true ? <Modal img={tempData[1]} title={tempData[2]} subTitle={tempData[3]} description={tempData[4]} technologies={tempData[5]} modalClose={modalClose} /> : ""}
    </>
  );
};
