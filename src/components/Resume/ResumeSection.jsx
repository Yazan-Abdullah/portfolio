...
const ResumeSection = ({ data }) => {
  const { educationTitle, education, experienceTitle, experience, coursesTitle, courses } = data;
  return (
      ...
      <div className="container"  data-aos="fade-up"
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="st-resume-wrap">
              <div className="st-resume-heading">
                <img src="/portfolio/images/icon/resume-icon1.png" alt="resume-icon" />
          ...
          <div className="col-lg-6">
            ...
            <div className="st-resume-wrap">
              <div className="st-resume-heading">
                <img src="/portfolio/images/icon/resume-icon2.png" alt="resume-icon" />
          ...
          <div className="col-lg-6">
            ...
            <div className="st-resume-wrap">
              <div className="st-resume-heading">
                <img src="/portfolio/images/icon/resume-icon2.png" alt="resume-icon" />
                <h2 className="st-resume-heading-title">{coursesTitle}</h2>
              </div>
              <div className="st-height-b50 st-height-lg-b30"></div>
              ...
              <div className="st-resume-timeline-wrap">
                {
                  courses.map((courses, index) => (
                    <SingleResume element={courses} key={index} />
                  ))
                }
              </div>
            </div>
